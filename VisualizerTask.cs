...
namespace Manipulation
{
	public static class VisualizerTask
	{
        ...
        public static void DrawManipulator(Graphics graphics, PointF shoulderPos)
		{
			...
			graphics.DrawLine(ManipulatorPen, drawPoints[0], drawPoints[1]);
			graphics.DrawLine(ManipulatorPen, drawPoints[1], drawPoints[2]);
			graphics.DrawLine(ManipulatorPen, drawPoints[2], drawPoints[3]);

			graphics.FillEllipse(JointBrush, drawPoints[0].X - 5, drawPoints[0].Y - 5, 10, 10);
			graphics.FillEllipse(JointBrush, drawPoints[1].X - 5, drawPoints[1].Y - 5, 10, 10);
			graphics.FillEllipse(JointBrush, drawPoints[2].X - 5, drawPoints[2].Y - 5, 10, 10);
		}
